...
@router.post("/", response_description="Create a new trip", status_code=status.HTTP_201_CREATED, response_model=Trip)
...
@router.get("/{id}", response_description="Get a single trip by id", response_model=Trip)
