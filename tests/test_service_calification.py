...
class TestCalification:
    ...
    def test_find_califications_of_passenger_by_trip_id(self):
        ...
        result = self.calification1 
        result['_id'] = '1'
        assert service.find_califications_of_passenger_by_tripId("100", 0, 1, mongo_client) == [result]
    ...
    def test_find_califications_of_driver_by_trip_id(self):
        ...
        result = self.calification2 
        result['_id'] = '2'
        assert service.find_califications_of_driver_by_tripId("101", 0, 1, mongo_client) == [result]
    ...
    def test_find_califications_of_passenger_by_tripId_and_by_passengerId(self):
        ...
        result = self.calification1 
        result['_id'] = '1'
        assert service.find_califications_of_passenger_by_tripId_and_by_passengerId("5", "100", 0, 1, mongo_client) == [result]
    ...
    def find_califications_of_driver_by_tripId_and_by_driverId(self):
        ...
        result = self.calification2
        result['_id'] = '2'
        assert service.find_califications_of_driver_by_tripId_and_by_driverId("4", "100", 0, 1, mongo_client) == [result]
    ...
    def test_find_califications_of_passenger_by_passengerId(self):
        ...
        result = self.calification2 
        result['_id'] = '2'
        assert service.find_califications_of_passenger_by_passengerId("3", 0, 1, mongo_client) == [result]
    ...
    def test_find_califications_of_driver_by_driverId(self):
        ...
        result = self.calification1 
        result['_id'] = '1'
        assert service.find_califications_of_driver_by_driverId("6", 0, 1, mongo_client) == [result]
    ...
    def test_find_califications_mean_of_driver_by_driverId(self):
        ...
        assert service.find_califications_mean_of_driver_by_driverId("6", mongo_client) == 4
    ...
    def test_find_califications_mean_of_driver_by_passengerId(self):
        ...
        assert service.find_califications_mean_of_driver_by_passengerId("3", mongo_client) == 2