...
class TestFareRulesService:
    ...
    def test_create_fare_rule(self):
        self.setUp()
        mongo_client = mongomock.MongoClient()
        assert service.create_fare_rule(mongo_client, self.fare_rule1) == self.fare_rule1
    ...
    def test_list_fare_rule(self):
        ...
        assert service.list_fare_rules(mongo_client) == [self.fare_rule1, self.fare_rule2]
